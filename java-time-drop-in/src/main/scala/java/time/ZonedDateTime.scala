...
class ZonedDateTime protected[time](f: ZonedDateTimeF) extends Wraps(f) with ChronoZonedDateTime[LocalDate] {
  ...
  def minus(amount: Long, unit: TemporalUnit): ZonedDateTime = f.minus(amount.toDouble, unit)
  def minusYears(yearsToSubtract: Long): ZonedDateTime = f.minusYears(yearsToSubtract.toDouble)
  def minusMonths(monthsToSubtract: Long): ZonedDateTime = f.minusMonths(monthsToSubtract.toDouble)
  def minusWeeks(weeksToSubtract: Long): ZonedDateTime = f.minusWeeks(weeksToSubtract.toDouble)
  def minusDays(daysToSubtract: Long): ZonedDateTime = f.minusDays(daysToSubtract.toDouble)
  def minusHours(hoursToSubtract: Long): ZonedDateTime = f.minusHours(hoursToSubtract.toDouble)
  def minusMinutes(minutesToSubtract: Long): ZonedDateTime = f.minusMinutes(minutesToSubtract.toDouble)
  def minusSeconds(secondsToSubtract: Long): ZonedDateTime = f.minusSeconds(secondsToSubtract.toDouble)
  def minusNanos(nanosToSubtract: Long): ZonedDateTime = f.minusNanos(nanosToSubtract.toDouble)
  def plus(amount: TemporalAmount): ZonedDateTime = f.plus(amount)
  def plus(amount: Long, unit: TemporalUnit): ZonedDateTime = f.plus(amount.toDouble, unit)
  def plusYears(yearsToAdd: Long): ZonedDateTime = f.plusYears(yearsToAdd.toDouble)
  def plusMonths(monthsToAdd: Long): ZonedDateTime = f.plusMonths(monthsToAdd.toDouble)
  def plusWeeks(weeksToAdd: Long): ZonedDateTime = f.plusWeeks(weeksToAdd.toDouble)
  def plusDays(daysToAdd: Long): ZonedDateTime = f.plusDays(daysToAdd.toDouble)
  def plusHours(hoursToAdd: Long): ZonedDateTime = f.plusHours(hoursToAdd.toDouble)
  def plusMinutes(minutesToAdd: Long): ZonedDateTime = f.plusMinutes(minutesToAdd.toDouble)
  def plusSeconds(secondsToAdd: Long): ZonedDateTime = f.plusSeconds(secondsToAdd.toDouble)
  def plusNanos(nanosToAdd: Long): ZonedDateTime = f.plusNanos(nanosToAdd.toDouble)
  ...
  def `with`(field: TemporalField, newValue: Long): ZonedDateTime = f.`with`(field, newValue.toDouble)
