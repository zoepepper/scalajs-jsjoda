...
import java.time
import java.time.{Instant, LocalTime, _}
...
object LocalDate extends js.Object {
  ...
  def from(temporal: temporal.Temporal): LocalDate = js.native
...
class LocalDate private(year: Int, month: Int, dayOfMonth: Int) extends ChronoLocalDate {
  ...
  def plus(amount: temporal.TemporalAmount): LocalDate = js.native
  ...
  def minus(amount: temporal.TemporalAmount): LocalDate = js.native
